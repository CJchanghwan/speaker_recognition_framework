...
We provide the following pre-trained `ECAPA-TDNN(trained with aam-infonce)` and if you want use wavLM download : `WavLM`: [pretrained_weight](https://drive.google.com/drive/folders/1cszCCaU2NpIZtliy92VfD0I89Zxn6cNK?usp=drive_link)
