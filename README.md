...
We provide the following pre-trained `ECAPA-TDNN(trained with our method)` or `ECAPA-TDNN(trained with AAMSoftmax)`and if you want use WavLM download : `WavLM` [pretrained_weight](https://drive.google.com/drive/folders/1cszCCaU2NpIZtliy92VfD0I89Zxn6cNK?usp=drive_link)
...
!CUDA_VISIBLE_DEVICES=0 python trainECAPAModel.py \
    ...
    --model ecapa-tdnn \ # model(vanila-ecapa-tdnn, ecapa-tdnn, resnet18, resnet34, resnet50, resnet101, resnet152, resnet221, resnet293, tdnn)
